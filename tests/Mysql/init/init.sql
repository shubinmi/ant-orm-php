...
CREATE TABLE `addresses` (
  ...
  CONSTRAINT `addressers_user_id_users_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
/*!40000 ALTER TABLE `addresses`
  DISABLE KEYS */;
INSERT INTO `addresses` (`id`, `user_id`, `address`, `zip`) VALUES (1, 1, 'Tyumen', 438921), (2, 1, 'LA', 100101);
/*!40000 ALTER TABLE `addresses`
  ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `hobbies` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_hobbies_name` (`name`)
)
  ENGINE = InnoDB
  AUTO_INCREMENT = 5
  DEFAULT CHARSET = utf8;
...
CREATE TABLE `profiles` (
  ...
  CONSTRAINT `profiles_user_id_users_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `users_hobbies` (
  ...
  CONSTRAINT `users_hobbies_hobby_id` FOREIGN KEY (`hobby_id`) REFERENCES `hobbies` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `users_hobbies_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
/*!40000 ALTER TABLE `users_hobbies`
  DISABLE KEYS */;
